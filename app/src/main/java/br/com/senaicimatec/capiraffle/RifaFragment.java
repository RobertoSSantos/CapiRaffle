 ...
 * Use the {@link RifaFragment#newInstance} factory method to
...
public class RifaFragment extends Fragment {
    ...
    public static RifaFragment newInstance(String param1, String param2) {
        RifaFragment fragment = new RifaFragment();
